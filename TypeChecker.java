...
public abstract class TypeChecker extends Parser
{
	...
	public static HashMap<String,HashMap<Integer,String>> ParaNameMap = new HashMap<String, HashMap<Integer,String>>();
		// for each real function call , records parameters
